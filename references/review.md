...
1. **Visual rhetoric**: does the poster's narrative carry? Are the headline numbers prominent within the locked direction’s register? On a restrained direction, prominence comes from position and contrast, not size. Is the framework banner readable from 2 m?
